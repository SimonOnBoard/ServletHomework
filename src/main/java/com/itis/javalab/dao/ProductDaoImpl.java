...
public class ProductDaoImpl implements ProductDao {
    ...
    private RowMapper<Product> productRowMapper = (row) -> {
        ...
        return new Product(id, name, price, ended, count, photoPath);
    };
    ...
    public void save(Product model) {
        try (PreparedStatement statement = connection.prepareStatement(
                "INSERT INTO product (name, price, ended, count, photopath) VALUES (?,?,?,?,?)",
                Statement.RETURN_GENERATED_KEYS)) {
    ...
    public void update(Product model) {
        try (PreparedStatement statement = connection.prepareStatement(
                "UPDATE product set name = ?, price = ?, ended = ?, count = ?, photopath = ? WHERE id = ?")) {
